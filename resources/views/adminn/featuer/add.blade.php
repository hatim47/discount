...
@section('content')
            ...
            <div class="row gy-4 justify-content-center">
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-body">
                         <form action="{{ route('featuer.store') }}" method="POST" enctype="multipart/form-data">
                                         @csrf
                        <div class="d-flex justify-content-between " >
                         <div class="" >
                            <h6 class="mb-4 text-xl">Featuer Page adding</h6>
                            ...
                            <div class="form-wizard">                              
                                    <div class="form-wizard-header overflow-x-auto scroll-sm pb-8 my-32">
                                        <ul class="list-unstyled form-wizard-list style-two">
                                            <li class="form-wizard-list__item active">
                                                ...
                                                <span class="text text-xs fw-semibold">Featuer Page start </span>
                                            </li>
                                    ...
                                    <fieldset class="wizard-fieldset show">
                                        <h6 class="text-md text-neutral-500">Featuer Page Information</h6>
                                        <div class="row gy-3">
                                            <div class="col-sm-6">
                                                <label class="form-label">Featuer Page Titel*</label>
                                                <div class="position-relative">
                                                    <input type="text" class="form-control wizard-required" name="titel" placeholder="Enter Featuer Page Name" required>
                                                    <div class="wizard-form-error"></div>
                                                </div>
                                            </div>
                                                <div class="col-sm-6">
                                                <label class="form-label">Featuer Page Description*</label>
                                                <div class="position-relative">
                                                    <input type="text" class="form-control wizard-required" name="descr" placeholder="Enter Featuer Page Description" required>
                                                    <div class="wizard-form-error"></div>
                                                </div>
                                            </div> 
...
<select class="form-control radius-8 form-select wizard-required" name="regions" id="region" style="">
    ...
    @endforeach
                    ...
                    <div class="col-12">
                                                ...
                                                <div class="position-relative">
                                                        <textarea id="editor3" name="content" class="form-control" rows="8"></textarea>
