...
@section('content')
            ...
            <div class="row gy-4 justify-content-center">
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-body">
                         <form action="{{ route('studentt.store') }}" method="POST" enctype="multipart/form-data">
                                         @csrf
                        <div class="d-flex justify-content-between " >
                         <div class="" >
                            <h6 class="mb-4 text-xl">Student Page adding</h6>
                            ...
                            <div class="form-wizard">                              
                                    <div class="form-wizard-header overflow-x-auto scroll-sm pb-8 my-32">
                                        <ul class="list-unstyled form-wizard-list style-two">
                                            <li class="form-wizard-list__item active">
                                                ...
                                                <span class="text text-xs fw-semibold">Student Page start </span>
                                            </li>
                                    ...
                                    <fieldset class="wizard-fieldset show">
                                        <h6 class="text-md text-neutral-500">Student Page Information</h6>
                                        <div class="row gy-3">
                                            <div class="col-sm-6">
                                                <label class="form-label">Student Page title*</label>
                                                <div class="position-relative">
                                                    <input type="text" class="form-control wizard-required" name="titel" placeholder="Enter Student Page title" required>
                                                    <div class="wizard-form-error"></div>
                                                </div>
                                            </div>
                                  
                                           <div class="col-sm-6">
                                                <label class="form-label">Student Page Description*</label>
                                                <div class="position-relative">
                                                    <input type="text" class="form-control wizard-required" name="descr" placeholder="Enter Student Page descr" required>
                                                    <div class="wizard-form-error"></div>
                                                </div>
                                            </div>
...
<select class="form-control radius-8 form-select wizard-required" name="regions" id="region" style="">
    ...
    @endforeach
                                   ...
                                   <div class="col-12">
                                                <label class="form-label">Description Below of Page*</label>
                                                <div class="position-relative">
