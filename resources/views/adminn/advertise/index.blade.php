...
@section('content')
            ...
            <div class="card basic-data-table">
                <div class="card-header d-flex justify-content-between">
                    <h5 class="card-title mb-0">Advertise Page Datatables</h5>
                    <a href="{{ route('advertise.create') }}" class="btn btn-success-900  radius-8 px-16 py-9" style="max-width: fit-content;">Add Advertise Page</a>
                </div> 
                <div class="card-body">
           ...
           data-id="{{ $store->id }}" class="edit-btn w-32-px h-32-px bg-success-focus text-success-main rounded-circle d-inline-flex align-items-center justify-content-center">
                        ...
                        <form action="{{ route('advertise.destroy', $store->id) }}" method="POST" style="display:inline" class="w-32-px h-32-px bg-danger-focus text-danger-main rounded-circle d-inline-flex align-items-center justify-content-center">
                            @csrf
                            @method('DELETE')
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Edit Advertise Page</h5>
...
document.addEventListener("DOMContentLoaded", function() {
 ...
 let url = "{{ route('advertise.edit', ':id') }}";
