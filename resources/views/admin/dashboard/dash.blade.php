    ...
    <div class="row row-cols-xxxl-4 row-cols-lg-4 row-cols-sm-2 row-cols-1 gy-4">
                <div class="col">
                    <div class="card shadow-none border h-100">
                           <div class="card-body p-20 relative">
                            <div class="d-flex flex-wrap align-items-center mb-5 justify-content-between gap-3">
                                <div>
                                    <p class="fw-medium text-primary-light mb-1">Total Users</p>
                                    <h6 class="mb-0">20,000</h6>
                                </div>
                                <div class="p-2 border rounded-2 shadow-2 d-flex justify-content-center align-items-center">
                                    <iconify-icon icon="heroicons:user-group" class="text-2xl mb-0"></iconify-icon>
                                </div>
                            </div>
                                  <div class="bg-white border-top-0 rounded-bottom absolute bottom-0 py-2 start-0 m-0 w-full  ">
                                  <p class="m-0 text-sm text-primary-light d-flex flex-row-reverse  align-items-center justify-content-between px-2">
                                <span class="d-inline-flex  flex-row-reverse align-items-center bg-success-100 rounded-4 px-2  gap-1 text-success-main">
                                    <iconify-icon icon="bxs:up-arrow" class="text-xs"></iconify-icon> +5000
                                </span>
                                Last 30 days users</p>
                            </div> 
                        </div>
                    </div><!-- card end -->
                </div>
                <div class="col">
                    <div class="card shadow-none border  h-100">
                           <div class="card-body p-20 relative">
                            <div class=" d-flex flex-wrap align-items-center mb-5 justify-content-between gap-3">
                                <div>
                                    <p class="fw-medium text-primary-light mb-1">Payrolls</p>
                                    <h6 class="mb-0">15,000</h6>
                                </div>
                                <div class="p-2 border rounded-2 shadow-2 d-flex justify-content-center align-items-center">
                                    <iconify-icon icon="fluent:receipt-money-16-regular" class="text-2xl mb-0"></iconify-icon>
                                </div>
                            </div>
                                  <div class="bg-white border-top-0 rounded-bottom  absolute bottom-0 py-2 start-0 m-0 w-full  ">
                                  <p class="m-0 text-sm text-primary-light  d-flex flex-row-reverse  align-items-center justify-content-between px-2">
                                 <span class="d-inline-flex  flex-row-reverse align-items-center bg-danger-100 rounded-4 px-2  gap-1 text-danger-main">
                ...
                <div class="col">
                    <div class="card shadow-none border   h-100">
                        <div class="card-body p-20 relative">
                            <div class="d-flex flex-wrap align-items-center mb-5 justify-content-between gap-3">
                                <div>
                                    <p class="fw-medium text-primary-light mb-1">New Hire</p>
                                    <h6 class="mb-0">5,000</h6>
                                </div>
                                <div class="p-2 border rounded-2 shadow-2 d-flex justify-content-center align-items-center">
                                    <iconify-icon icon="heroicons:user-plus" class="text-2xl mb-0"></iconify-icon>
                                </div>
                            </div>
                                  <div class="bg-white border-top-0 rounded-bottom  absolute bottom-0 py-2 start-0 m-0 w-full  ">
                                  <p class="m-0 text-sm text-primary-light d-flex flex-row-reverse  align-items-center justify-content-between px-2">
                ...
                <div class="col">
                    <div class="card shadow-none border  h-100">
                          <div class="card-body p-20 relative">
                            <div class="d-flex flex-wrap align-items-center mb-5 justify-content-between gap-3">
                                <div>
                                    <p class="fw-medium text-primary-light mb-1">Resigned Employees</p>
                                    <h6 class="mb-0">$42,000</h6>
                                </div>
                                <div class="p-2 border rounded-2 shadow-2 d-flex justify-content-center align-items-center">
                                    <iconify-icon icon="tdesign:user-blocked" class="text-2xl mb-0"></iconify-icon>
                                </div>
                ...
                <div class="col">
                    <div class="card shadow-none border  h-100">
                            ...
                            <div class="d-flex flex-wrap align-items-center mb-5 justify-content-between gap-3">
                                <div>
                                    <p class="fw-medium text-primary-light mb-1">Present Employees</p>
                                    <h6 class="mb-0">$30,000</h6>
                                </div>
                                 <div class="p-2 border rounded-2 shadow-2 d-flex justify-content-center align-items-center">
                                    <iconify-icon icon="tdesign:user-checked" class="text-2xl mb-0"></iconify-icon>
                                </div>
                  ...
                  <div class="col">
                    <div class="card shadow-none border  h-100">
                         <div class="card-body p-20 relative">
                            <div class="d-flex flex-wrap align-items-center mb-5 justify-content-between gap-3">
                                <div>
                                    <p class="fw-medium text-primary-light mb-1">Absent Employees</p>
                                    <h6 class="mb-0">5,000</h6>
                                </div>
                              <div class="p-2 border rounded-2 shadow-2 d-flex justify-content-center align-items-center">
                                    <iconify-icon icon="heroicons-outline:user-remove" class="text-2xl mb-0"></iconify-icon>
                                </div>
                            </div>
                                  <div class="bg-white border-top-0 rounded-bottom  absolute bottom-0 py-2 start-0 m-0 w-full  ">
                                  <p class="m-0 text-sm text-primary-light d-flex flex-row-reverse  align-items-center justify-content-between px-2">
                ...
                <div class="col">
                    <div class="card border shadow-2 h-100">
                           <div class="card-body p-20 relative">
                            <div class="d-flex flex-wrap align-items-center mb-5 justify-content-between gap-3">
                                <div>
                                    <p class="fw-medium text-primary-light mb-1">On Leave</p>
                                    <h6 class="mb-0">$42,000</h6>
                                </div>
                                <div class="p-2 border rounded-2 shadow-2 d-flex justify-content-center align-items-center">
                                    <iconify-icon icon="tdesign:user-visible" class="text-2xl mb-0"></iconify-icon>
                                </div>
                            </div>
                                  <div class="bg-white border-top-0 rounded-bottom  absolute bottom-0 py-2 start-0 m-0 w-full  ">
                                  <p class="m-0 text-sm text-primary-light d-flex flex-row-reverse align-items-center justify-content-between px-2">
                ...
                <div class="col">
                    <div class="card shadow-none border  h-100">
                           <div class="card-body p-20 relative">
                            <div class="d-flex flex-wrap align-items-center mb-5 justify-content-between gap-3">
                                <div>
                                    <p class="fw-medium text-primary-light mb-1">Remote Employees</p>
                                    <h6 class="mb-0">$30,000</h6>
                                </div>
                               <div class="p-2 border rounded-2 shadow-2 d-flex justify-content-center align-items-center">
                                    <iconify-icon icon="streamline-ultimate:meeting-remote" class="text-2xl mb-0"></iconify-icon>
                                </div>
                            </div>
                                  <div class="bg-white border-top-0 rounded-bottom  absolute bottom-0 py-2 start-0 m-0 w-full  ">
                                  <p class="m-0 text-sm text-primary-light d-flex flex-row-reverse  align-items-center justify-content-between px-2">
