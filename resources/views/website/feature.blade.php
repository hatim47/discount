...
{!! $jsonLd !!}
            ...
            <div class="flex items-center gap-4 ms-3">
                ...
                <div>
                    ...
                    <nav class="text-sm mb-1 text-gray-500">
                        ...
                        <a href="{{region_route('featured') }}" class="hover:underline">Featured Coupons</a>
                    </nav>

                    <!-- Title -->
                    <h1 class="text-lg sm:text-2xl font-bold text-gray-900"> Featured Coupon Codes </h1>
                    <!-- Description -->
 ...
 <section class="bg-[#F2FCFA] text-[#0F0F0F]">
    <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6  gap-6  grid grid-cols-1 lg:grid-cols-10 ">
     {{-- column one start  --}}
      <div class="flex flex-col ms-3  gap-6 lg:col-span-1">
      </div> 
    <div class="flex flex-col ms-3  gap-6 lg:col-span-8">
